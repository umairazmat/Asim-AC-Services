      ...
      >
        <div className="header-top__row header-top__row--primary">
          ...
          <div className="header-top__group header-top__group--middle">
            ...
            <span className="header-top__divider header-top__divider--before-email" aria-hidden="true" />
            ...
            >
              <EmailIcon />
              <span className="header-top__item-text">{CONTACT.email.label[locale]}</span>
            </a>
